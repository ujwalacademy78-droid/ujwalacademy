...
import { Users, CreditCard, Video, Activity } from "lucide-react";
...
export default function AdminDashboard() {
    ...
    const premiumStudents = users.filter(u => u.role === 'student' && u.subscription === 'premium').length;
        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{premiumStudents}</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{totalContent} Videos</div>
                        <p className="text-xs text-muted-foreground">3 new uploaded today</p>
                    </CardContent>
                </Card>
            </div>
